/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9eaa94c0247c84c36f8f8a8088bcffe8)
// Runtime types generated with workerd@1.20251008.0 2025-05-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/cf-worker/index");
		durableNamespaces: "WebSocketServer" | "AuthRegistry";
	}
	interface Env {
		JWT_SECRET: string;
		WEBSOCKET_SERVER: DurableObjectNamespace<import("./src/cf-worker/index").WebSocketServer>;
		AUTH_REGISTRY: DurableObjectNamespace<import("./src/cf-worker/index").AuthRegistry>;
	}
}
